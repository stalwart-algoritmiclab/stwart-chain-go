...
export interface SecuredAddresses {
  /** @format uint64 */
  id?: string;
  address?: string[];
  creator?: string;
...
export type SecuredParams = object;
...
/**
 * @title HTTP API Console stwartchain.secured
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/stwart/secured/addresses
   */
  queryAddressesAll = (
    query?: {
   ...
   * @tags Query
   * @name QueryAddresses
   * @request GET:/stwart/secured/addresses/{id}
   */
  queryAddresses = (id: string, params: RequestParams = {}) =>
    this.request<
      ...
      { code?: number; message?: string; details?: { "@type"?: string }[] }
    >({
      path: `/stwart/secured/addresses/${id}`,
      method: "GET",
      ...params,
    });
