...
type App struct {
	*runtime.App
	...
	StwartKeeper        stwartmodulekeeper.Keeper
	SecuredKeeper       securedmodulekeeper.Keeper
	FeepolicyKeeper     feepolicymodulekeeper.Keeper
	SystemrewardsKeeper systemrewardsmodulekeeper.Keeper
	ReferralKeeper      referralmodulekeeper.Keeper
	CoreKeeper          coremodulekeeper.Keeper
	StatsKeeper         statsmodulekeeper.Keeper
	UsersKeeper         usersmodulekeeper.Keeper
	RatesKeeper         ratesmodulekeeper.Keeper
...
func New(
	...
	// A custom AnteHandler can be set if extra ante-handler logic is required.
	anteHandler, err := coreante.NewAnteHandler(
		coreante.HandlerOptions{
			AccountKeeper:   app.AccountKeeper,
			BankKeeper:      app.BankKeeper,
			FeeKeeper:       app.BankKeeper,
			...
			CoreKeeper:      app.CoreKeeper,
			RefKeeper:       app.ReferralKeeper,
