...
const (
	Query_Params_FullMethodName       = "/stwartchain.rates.Query/Params"
	Query_Addresses_FullMethodName    = "/stwartchain.rates.Query/Addresses"
	Query_AddressesAll_FullMethodName = "/stwartchain.rates.Query/AddressesAll"
	Query_Rates_FullMethodName        = "/stwartchain.rates.Query/Rates"
	Query_RatesAll_FullMethodName     = "/stwartchain.rates.Query/RatesAll"
)
...
func (c *queryClient) Rates(ctx context.Context, in *QueryGetRatesRequest, opts ...grpc.CallOption) (*QueryGetRatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Rates_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) RatesAll(ctx context.Context, in *QueryAllRatesRequest, opts ...grpc.CallOption) (*QueryAllRatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_RatesAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Rates(context.Context, *QueryGetRatesRequest) (*QueryGetRatesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Rates not implemented")
}
func (UnimplementedQueryServer) RatesAll(context.Context, *QueryAllRatesRequest) (*QueryAllRatesResponse, error) {
...
func _Query_RatesAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_RatesAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
