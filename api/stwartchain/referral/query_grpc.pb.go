...
const (
	Query_Params_FullMethodName  = "/stwartchain.referral.Query/Params"
	Query_User_FullMethodName    = "/stwartchain.referral.Query/User"
	Query_UserAll_FullMethodName = "/stwartchain.referral.Query/UserAll"
)
