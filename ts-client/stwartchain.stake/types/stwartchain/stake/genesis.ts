...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, stakeList: [] };
}
...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.stakeList) {
      Stake.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      stakeList: Array.isArray(object?.stakeList) ? object.stakeList.map((e: any) => Stake.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.stakeList?.length) {
      obj.stakeList = message.stakeList.map((e) => Stake.toJSON(e));
    }
    return obj;
  },
