...
func TestAddressesMsgServerUpdate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			desc: "Completed",
			request: &types.MsgUpdateAddresses{
				Address: "stwart1r92s60x75ashfyjy034kxzdml43y6xrqcafk69",
				Creator: creator,
			},
		},
		{
	...
	for _, tc := range tests {
		t.Run(tc.desc, func(t *testing.T) {
			...
			_, err := srv.CreateAddresses(wctx, &types.MsgCreateAddresses{
				Creator: creator,
				Address: "stwart1hdl6ny2kdpvth9p7u43ar9qer7tcvualelp0at",
			},
			)
			require.NoError(t, err)
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				msg: &types.MsgCreateAddresses{
					Creator: "stwart1hdl6ny2kdpvth9p7u43ar9qer7tcvualelp0at",
					Address: "stwart1fl48vsnmsdzcv85q5d2q4z5ajdha8yu35a79u7",
				},
			},
			want: &types.MsgCreateAddressesResponse{
				Id: 2,
		...
		},
		{
			...
			args: args{
				...
				msg: &types.MsgUpdateAddresses{
					Creator: "stwart1hdl6ny2kdpvth9p7u43ar9qer7tcvualelp0at",
					Id:      0,
					Address: "stwart1tygms3xhhs3yv487phx3dw4a95jn7t7lqaz522",
				},
			},
			want:    nil,
			wantErr: true,
