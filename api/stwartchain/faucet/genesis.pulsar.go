...
var (
	...
	fd_GenesisState_tokensList  protoreflect.FieldDescriptor
	fd_GenesisState_tokensCount protoreflect.FieldDescriptor
)

func init() {
	file_stwartchain_faucet_genesis_proto_init()
	md_GenesisState = File_stwartchain_faucet_genesis_proto.Messages().ByName("GenesisState")
	fd_GenesisState_params = md_GenesisState.Fields().ByName("params")
	fd_GenesisState_tokensList = md_GenesisState.Fields().ByName("tokensList")
	fd_GenesisState_tokensCount = md_GenesisState.Fields().ByName("tokensCount")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.TokensList) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_2_list{list: &x.TokensList})
		if !f(fd_GenesisState_tokensList, value) {
			return
		}
	}
	if x.TokensCount != uint64(0) {
		value := protoreflect.ValueOfUint64(x.TokensCount)
		if !f(fd_GenesisState_tokensCount, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "stwartchain.faucet.GenesisState.params":
		return x.Params != nil
	case "stwartchain.faucet.GenesisState.tokensList":
		return len(x.TokensList) != 0
	case "stwartchain.faucet.GenesisState.tokensCount":
		return x.TokensCount != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stwartchain.faucet.GenesisState"))
		}
		panic(fmt.Errorf("message stwartchain.faucet.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "stwartchain.faucet.GenesisState.tokensList":
		...
		listValue := &_GenesisState_2_list{list: &x.TokensList}
	...
	default:
		...
		panic(fmt.Errorf("message stwartchain.faucet.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "stwartchain.faucet.GenesisState.tokensList":
		...
		x.TokensList = *clv.list
	case "stwartchain.faucet.GenesisState.tokensCount":
		x.TokensCount = value.Uint()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stwartchain.faucet.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "stwartchain.faucet.GenesisState.tokensList":
		...
		value := &_GenesisState_2_list{list: &x.TokensList}
		return protoreflect.ValueOfList(value)
	case "stwartchain.faucet.GenesisState.tokensCount":
		panic(fmt.Errorf("field tokensCount of message stwartchain.faucet.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stwartchain.faucet.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in stwartchain.faucet.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.TokensList) > 0 {
			for _, e := range x.TokensList {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if x.TokensCount != 0 {
			n += 1 + runtime.Sov(uint64(x.TokensCount))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.TokensCount != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.TokensCount))
			i--
			dAtA[i] = 0x18
		}
		if len(x.TokensList) > 0 {
			for iNdEx := len(x.TokensList) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.TokensList[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TokensList", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TokensList = append(x.TokensList, &Tokens{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.TokensList[len(x.TokensList)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 3:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TokensCount", wireType)
				}
				x.TokensCount = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.TokensCount |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
var file_stwartchain_faucet_genesis_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0xb4, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x74,
	...
	,
}
